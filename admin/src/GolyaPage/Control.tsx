...
const Controls = () => {
    ...
    const createCSV = () => {
        const getGolyaArray = (golya: GolyaAdat) => {
            ...
            const hetfo = golya.napok.hetfo ? "igen" : "nem";
            const kedd = golya.napok.kedd ? "igen" : "nem";
            const szerda = golya.napok.szerda ? "igen" : "nem";
            const csutortok = golya.napok.csutortok ? "igen" : "nem";
            const pentek = golya.napok.pentek ? "igen" : "nem";
            ...
            return [`${golya.id}`, golya.nev, golya.email, golya.szak,
                ...
                golya.szuletesDatum, golya.szuletesHely,  golya.poloMeret, hetfo,
                kedd, szerda, csutortok, pentek, golya.anyjaNeve, allergia,
                etelerzekenyseg, egyeb, formatDate(golya.regisztralt, "long-csv")
            ]
        }
        const rows = [
